...
MODEL_PATH = r'C:\Users\gouda\Desktop\graduation project\keras-flask-deploy-webapp-master\models\bestModelDensenetOversample.h5'
...
def predict():
    if request.method == 'POST':
        ...
        img.save("image.png")
        image_width, image_height = 176, 176
